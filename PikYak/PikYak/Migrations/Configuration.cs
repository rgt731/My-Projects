        ...
        protected override void Seed(PikYak.Models.ApplicationDbContext context)
        {
            ...
            //
                context.Yaks.AddOrUpdate(
                  p => p.Id,
                  new YakClass { Text = "This is my first yak, its super positive", Latitude = 69, Longitude = 102, Positivity = 99, Timestamp = DateTime.Now  },
                  new YakClass { Text = "This is my second yak, its somewhat positive", Latitude = 87, Longitude = 304, Positivity = 55, Timestamp = DateTime.Now },
                  new YakClass { Text = "This is my third yak, its a little positive", Latitude = 17, Longitude = 44, Positivity = 17, Timestamp = DateTime.Now }
